...
private:
  ...
  static constexpr uint8_t diagPayloadBufSize = 160U;                                                     // 70 fixed chars + cause (28: "MQTT_CONNECT_BAD_CREDENTIALS") + ISO time (20) + 3x uint32 (10 each) + 2x uint16 (5 each) + null.
