...
private:
  ...
  static constexpr uint8_t diagPayloadBufSize = 180U;                                                     // 83 fixed chars + cause (28: "MQTT_CONNECT_BAD_CREDENTIALS") + ISO time (20) + 3x uint32 (10 each) + 3x uint16 (5 each) + null.
