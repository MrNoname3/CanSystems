...
bool test_connect_properly_formatted() {
  ...
  uint8_t connect[] = {0x10U, 0x18U, 0x0U, 0x4U, 0x4dU, 0x51U, 0x54U, 0x54U, 0x4U, 0x2U, 0x0U, 0xfU, 0x0U, 0xcU, 0x63U, 0x6cU, 0x69U, 0x65U, 0x6eU, 0x74U, 0x5fU, 0x74U, 0x65U, 0x73U, 0x74U, 0x31U};
...
bool test_connect_fails_on_bad_rc() {
  ...
  ShimClient shimClient;
  shimClient.setAllowConnect(true);
  uint8_t connack[] = {0x20U, 0x02U, 0x00U, 0x01U};
  shimClient.respond(connack, 4U);
  ...
  int8_t state = client.state();
  IS_TRUE(state == MQTT_CONNECT_BAD_PROTOCOL);
...
bool test_connect_non_clean_session() {
  ...
  uint8_t expectServer[] = {172U, 16U, 0U, 2U};
  shimClient.expectConnect(expectServer, 1883);
  uint8_t connect[] = {0x10U, 0x18U, 0x0U, 0x4U, 0x4dU, 0x51U, 0x54U, 0x54U, 0x4U, 0x0U, 0x0U, 0xfU, 0x0U, 0xcU, 0x63U, 0x6cU, 0x69U, 0x65U, 0x6eU, 0x74U, 0x5fU, 0x74U, 0x65U, 0x73U, 0x74U, 0x31U};
  uint8_t connack[] = {0x20U, 0x02U, 0x00U, 0x00U};
...
bool test_connect_accepts_username_password() {
  ...
  uint8_t connect[] = {0x10U, 0x24U, 0x0U, 0x4U, 0x4dU, 0x51U, 0x54U, 0x54U, 0x4U, 0xc2U, 0x0U, 0xfU, 0x0U, 0xcU, 0x63U, 0x6cU, 0x69U, 0x65U, 0x6eU, 0x74U, 0x5fU, 0x74U, 0x65U, 0x73U, 0x74U, 0x31U, 0x0U, 0x4U, 0x75U, 0x73U, 0x65U, 0x72U, 0x0U, 0x4U, 0x70U, 0x61U, 0x73U, 0x73U};
  uint8_t connack[] = {0x20U, 0x02U, 0x00U, 0x00U};
...
bool test_connect_accepts_username_no_password() {
  ...
  uint8_t connect[] = {0x10U, 0x1eU, 0x0U, 0x4U, 0x4dU, 0x51U, 0x54U, 0x54U, 0x4U, 0x82U, 0x0U, 0xfU, 0x0U, 0xcU, 0x63U, 0x6cU, 0x69U, 0x65U, 0x6eU, 0x74U, 0x5fU, 0x74U, 0x65U, 0x73U, 0x74U, 0x31U, 0x0U, 0x4U, 0x75U, 0x73U, 0x65U, 0x72U};
  uint8_t connack[] = {0x20U, 0x02U, 0x00U, 0x00U};
...
bool test_connect_accepts_username_blank_password() {
  ...
  uint8_t connect[] = {0x10U, 0x20U, 0x0U, 0x4U, 0x4dU, 0x51U, 0x54U, 0x54U, 0x4U, 0xc2U, 0x0U, 0xfU, 0x0U, 0xcU, 0x63U, 0x6cU, 0x69U, 0x65U, 0x6eU, 0x74U, 0x5fU, 0x74U, 0x65U, 0x73U, 0x74U, 0x31U, 0x0U, 0x4U, 0x75U, 0x73U, 0x65U, 0x72U, 0x0U, 0x0U};
  uint8_t connack[] = {0x20U, 0x02U, 0x00U, 0x00U};
  shimClient.expect(connect, 0x26U);
  shimClient.respond(connack, 4U);
...
bool test_connect_custom_keepalive() {
  ...
  uint8_t connect[] = {0x10U, 0x18U, 0x0U, 0x4U, 0x4dU, 0x51U, 0x54U, 0x54U, 0x4U, 0x2U, 0x01U, 0x2cU, 0x0U, 0xcU, 0x63U, 0x6cU, 0x69U, 0x65U, 0x6eU, 0x74U, 0x5fU, 0x74U, 0x65U, 0x73U, 0x74U, 0x31U};
  uint8_t connack[] = {0x20U, 0x02U, 0x00U, 0x00U};
