...
bool test_connect_properly_formatted() {
  ...
  shimClient.setAllowConnect(true);
  uint8_t expectServer[] = {172, 16, 0, 2};
  shimClient.expectConnect(expectServer, 1883);
  uint8_t connect[] = {0x10, 0x18, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0x2, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31};
...
bool test_connect_fails_on_bad_rc() {
  ...
  ShimClient shimClient;
  shimClient.setAllowConnect(true);
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x01};
  shimClient.respond(connack, 4);
...
bool test_connect_non_clean_session() {
  ...
  uint8_t expectServer[] = {172, 16, 0, 2};
  shimClient.expectConnect(expectServer, 1883);
  uint8_t connect[] = {0x10, 0x18, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0x0, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
...
bool test_connect_accepts_username_password() {
  ...
  uint8_t connect[] = {0x10, 0x24, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0xc2, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31, 0x0, 0x4, 0x75, 0x73, 0x65, 0x72, 0x0, 0x4, 0x70, 0x61, 0x73, 0x73};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
...
bool test_connect_accepts_username_no_password() {
  ...
  uint8_t connect[] = {0x10, 0x1e, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0x82, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31, 0x0, 0x4, 0x75, 0x73, 0x65, 0x72};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
...
bool test_connect_accepts_username_blank_password() {
  ...
  uint8_t connect[] = {0x10, 0x20, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0xc2, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31, 0x0, 0x4, 0x75, 0x73, 0x65, 0x72, 0x0, 0x0};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
  shimClient.expect(connect, 0x26);
  shimClient.respond(connack, 4);
...
bool test_connect_with_will() {
  ...
  uint8_t connect[] = {0x10, 0x30, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0xe, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31, 0x0, 0x9, 0x77, 0x69, 0x6c, 0x6c, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x0, 0xb, 0x77, 0x69, 0x6c, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
...
bool test_connect_with_will_username_password() {
  ...
  uint8_t connect[] = {0x10, 0x40, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0xce, 0x0, 0xf, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31, 0x0, 0x9, 0x77, 0x69, 0x6c, 0x6c, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x0, 0xb, 0x77, 0x69, 0x6c, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x0, 0x4, 0x75, 0x73, 0x65, 0x72, 0x0, 0x8, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
...
bool test_connect_custom_keepalive() {
  ...
  uint8_t connect[] = {0x10, 0x18, 0x0, 0x4, 0x4d, 0x51, 0x54, 0x54, 0x4, 0x2, 0x01, 0x2c, 0x0, 0xc, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x31};
  uint8_t connack[] = {0x20, 0x02, 0x00, 0x00};
