...
bool test_diagPayloadBufSize() {
  ...
  TEST(n > 0 && static_cast<size_t>(n) < sizeof(buf));
  IS_EQUAL(strcmp(buf, R"({"cause":"MQTT_CONNECT_BAD_CREDENTIALS","at":"2026-08-29T10:12:33Z","downSec":4294967295,"upSec":4294967295,"n":4294967295,"pingRetry":65535,"pingLate":65535})"), 0);
  END_IT
}
