...
bool test_triple_tap_returns_5() {
  ...
  PushButton btn = make();
  btn.buttonCheck(0U, false);
  btn.buttonCheck(80U, false);
  btn.buttonCheck(90U, true);  // 1st release; cnt=3
  btn.buttonCheck(110U, false);
  btn.buttonCheck(190U, false);
  btn.buttonCheck(200U, true);  // 2nd release; cnt=4
  btn.buttonCheck(220U, false);
  btn.buttonCheck(300U, false);
  btn.buttonCheck(310U, true);  // 3rd release; cnt=5, lastEventTime=310
